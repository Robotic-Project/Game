...
# Block Colors
BLOCK_BORDER_COLOR = QtGui.QColor(0, 255, 120, 255)
BLOCK_FILL_COLOR = QtGui.QColor(0, 255, 30, 200) # 25
BLOCK_GLOWING_BORDER_COLOR = QtGui.QColor(0, 255, 0, 255)
BLOCK_GLOWING_FILL_COLOR = QtGui.QColor(60, 255, 60, 140) # 70
BLOCK_LIGHT_COLOR = QtGui.QColor(60, 255, 200, 110) # 40
...
GRID_GRIDLINE_COLOR = QtGui.QColor(50, 255, 50, 200) # 65
...
STATS_ROWS = 15
STATS_COLUMNS = 6
STATS_TEXT_COLOR = QtGui.QColor(100,  255, 0, 255) # 128
SCORES = (
